...
class JoinTest {
    ...
    static void setupTest() {
        ...
        new TestTable("Test1", testColumn);
        new TestTable("Test2", testColumn2);
        new TestTable("Test3", testColumn3);
    }

    @Test
    void testJoinConstructorWithTrueArguments() {
        Assertions.assertDoesNotThrow(() -> new Join(Join.Type.INNER_JOIN, testColumn, testColumn2));
    }
