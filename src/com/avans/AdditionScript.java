...
public class AdditionScript {
    ...
    public static void addData() {
        ...
        NFS.getHandler().addSerie("The Flash", "Superheroes");

        Serie theFlash = (Serie) NFS.getHandler().getProgram("The Flash");
        ...
        NFS.getHandler().addSerie("Breaking Bad", "Crime");
        ...
        NFS.getHandler().addSerie("Rick and Morty", "Animation");

        Serie rickAndMorty = (Serie) NFS.getHandler().getProgram("Rick and Morty");
        ...
        NFS.getHandler().addSerie("Narcos", "Crime");

        Serie narcos = (Serie) NFS.getHandler().getProgram("Narcos");
        ...
        NFS.getHandler().addSerie("Friends", "Comedy");

        Serie friends = (Serie) NFS.getHandler().getProgram("Friends");
        ...
        NFS.getHandler().addSerie("House of Cards", "Drama");

        Serie houseOfCards = (Serie) NFS.getHandler().getProgram("House of Cards");
        ...
        NFS.getHandler().addSerie("Black Mirror", "Science Fiction");

        Serie blackMirror = (Serie) NFS.getHandler().getProgram("Black Mirror");
